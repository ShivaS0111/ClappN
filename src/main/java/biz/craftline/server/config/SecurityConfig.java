...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // Public auth endpoints only (not the entire /api/auth/** tree)
                        .requestMatchers(
                                "/api/auth/register",
                                "/api/auth/login",
                        ...
                        // Everything else requires authentication (+ @RequirePermission / request scope)
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setExposedHeaders(List.of("X-Store-Id", "X-Business-Id"));
