...
CREATE TABLE `store_products` (
  ...
  KEY `FKtgjbej4sn43lo4ahohn1eqkte` (`store_product_id`),
  CONSTRAINT `FK7ajkqsjo8mdfh213onp1r0kcm` FOREIGN KEY (`store_id`) REFERENCES `store` (`id`),
  CONSTRAINT `FKtgjbej4sn43lo4ahohn1eqkte` FOREIGN KEY (`store_product_id`) REFERENCES `store_offered_product` (`id`)
